# nifty100_project/settings.py
"""
Django settings for nifty100_project project.
Generated for Nifty 100 Financial Intelligence System
"""
...
SECRET_KEY = 'django-insecure-8x@2w!9q#k$m4n%p7r&t*y(u*i*o(p)l+k,j,m/n.b?v8c6x3z'
...
if not os.path.exists(LOGS_DIR):
    ...
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # This should already be there
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.debug',
